...
namespace Demo.Views
{
    ...
    public partial class SfListViewPage : ContentPage
    {
        ...
        public SfListViewPage()
        {
            ...
            Items.Add(new Goods() { Id = 16, Image = "goods_1.png", Name = "단단한 돌파석", Description = "장비 재련에 사용되는 단단한 돌파석." });
            Items.Add(new Goods() { Id = 17, Image = "goods_2.png", Name = "부서진 돌파석", Description = "장비 재련에 사용되는 부서진 돌파석." });
            Items.Add(new Goods() { Id = 18, Image = "goods_3.png", Name = "태양석 파편 주머니", Description = "태양석 파편이 담겨 있는 주머니." });
            Items.Add(new Goods() { Id = 19, Image = "goods_4.png", Name = "용암의 숨결", Description = "뜨거운 용암의 힘을 품고 있다." });
            Items.Add(new Goods() { Id = 20, Image = "goods_5.png", Name = "대지의 숨결", Description = "희미한 대지의 힘을 품고 있다." });
